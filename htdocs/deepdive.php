...
<html>
<head>
    <base href="http://deepdive.local/deepdive.php">

    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE10">
    <title>DeepDive 1.0</title>
...
<body style="margin-botton: 0; margin-top: 0; margin-right: 0; margin-left: 0;">
    ...
    <script type="text/javascript">
                        ...
                        toolbar: {
                            items: [
                                ...
                                },
                                {
                                    ...
                                    onClick: function(event)
                                    {
                                        ...
                                        var url = deepDiveSearch(el.value);
                                        w2ui['layout'].content('main',
                                            '<iframe src="' + url + '" ' +
                                            'style="border: none; min-width: 100%; min-height: 100%;">' +
                                            '</iframe>');
                                ...
                                { type:      'menu',
                                    ...
                                    items: [
                                        ...
                                        {
                                            id:   'help_deepdive_overview',
                                            text: 'DeepDive Overview',
                                            img:  'home'
                                        },
                                        {
                                            id:   'help_deepdive_approve',
                                            text: 'DeepDive Approve',
                                            img:  'home'
                                        },
                                        {
                                            id:   'help_deepdive_new_work_request',
                                            text: 'DeepDive New Work Request',
                                            img:  'home'
                                        }
                                    ]
                                },
                            ...
                            onClick: function(target, info)
                            {
                                ...
                                switch (target)
                                {
                                    ...
                                    case "help_index:help_deepdive_overview":
                                        help_file = 'xxx.php';
                                        w2ui['layout'].content('main',
                                            '<iframe src="deepdive_overview.html" ' +
                                            'style="border: none; min-width: 100%; min-height: 100%;">' +
                                            '</iframe>');
                                        break;

                                    case "help_index:help_deepdive_approve":
                                        help_file = 'xxx.php';
                                        w2ui['layout'].content('main',
                                            '<iframe src="deepdive_approve.html" ' +
                                            'style="border: none; min-width: 100%; min-height: 100%;">' +
                                            '</iframe>');
                                        break;

                                    case "help_index:help_deepdive_new_work_request":
                                        help_file = 'xxx.php';
                                        w2ui['layout'].content('main',
                                            '<iframe src="deepdive_new_work_request.html" ' +
                                            'style="border: none; min-width: 100%; min-height: 100%;">' +
                                            '</iframe>');
                                        break;
                                    //
        ...
        function deepDiveSearch(search_buffer)
        {
