...
(/** @lends <deepdive_page_counts> */function( window, document, undefined ) {
...
(/** @lends <global> */function( $ ) {
	 ...
	 *
	 * Note that the `DataTable` object is not a deepdive_page_counts variable but is aliased
	 ...
	 * DataTables functions can access them and they don't leak into deepdive_page_counts space.
	...
	function _fnSetObjectDataFn( mSource )
	{
		if ( $.isPlainObject( mSource ) )
		{
			/* Unlike get, only the underscore (deepdive_page_counts) option is used for for
	...
	/**
	 * Filter the table using both the deepdive_page_counts filter and column based filtering
	 *  @param {object} oSettings dataTables settings object
	...
	DataTable = function( options )
	{
		 ...
		 *  @param {bool} [bShowGlobal=true] Show the input deepdive_page_counts filter in it's input box(es)
		...
		this.each(function() {
			...
			/*deepdive_page_counts oInit,_that,emptyInit*/
	 ...
	 * search information for the deepdive_page_counts filter and individual column filters.
	 *  @namespace
	 */
	...
	DataTable.defaults = {
		...
		/**
		 * This parameter allows you to have define the deepdive_page_counts filtering state at
	...
	DataTable.models.oSettings = {
		...
		/**
		 * Store the applied deepdive_page_counts search information in case we want to force a
	 ...
	 * built-in deepdive_page_counts search, or column filters) is altered.
