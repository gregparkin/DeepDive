...
class library extends SqlFormatter
{
	 ...
	 * @fn     globalCounter()
	 *
	 * @brief  Update the deepdive_page_counts counter file for footer.php
	 *
	 * @return int
	 */
	public function globalCounter()
	{
		...
		// $_SESSION['COUNTER_FILE']      = '/Users/gregparkin/www/visionlink.test/counters/deepdive_page_counts';

		$page_hit_file = "/Users/gregparkin/www/deepdive/counters/deepdive_page_counts";
	 ...
	 * @fn    environment_dump()
	 *
	 * @brief If running from apache this function dump the apache server deepdive_page_counts arrays.
	 */
